...
class LogLogSketch(Interface):
    ...
    def __init__(self, maxCardinality, error_rate):
        ...
        *maxCardinality
        ...
        self._bucketList = [bitarray(self._bucketSize) for _ in range(self._bucketNumber)]
...
class SuperLogLogSketch(Interface):
    ...
    def __init__(self, maxCardinality, error_rate):
       ...
       error_rate
        ...
        # M(1)... M(m) = 0
        self._bucketList = [0 for _ in range(self._bucketNumber)]
    ...
    def add(self, item):
        ...
        self._bucketList[index] = self._restrition_rule(
            max(self._bucketList[index], getIndex(binword[self._k:], 160 - self._k)))
